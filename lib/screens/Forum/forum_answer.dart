...
class _ForumAnswerState extends State<ForumAnswer> {
  ...
  Stream myStream, userStream, postStream;
  ...
  void addReply() async {
    ...
    try {
      ...
      if (currentUserEmail != widget.email) {
        notifyUser(postId: widget.id, reply: replyController.text);
      }
  ...
  void notifyUser({String postId, String reply}) async {
    try {
      setState(() {
        isLoading = true;
      });
      ...
      userCollection
          ...
          .set({
        'id': id,
        'title': currentUserName.toString() + ' replied to your post',
        'reply': reply,
        'profilePic': currentUserProfilePic,
        'email': currentUserEmail,
        'postId': postId,
                                    ...
                                    : ListView.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return ForumReplyTile(
                                            ...
                                            parentPostName: widget.name,
                                            parentPostEmail: widget.email,
