...
class UniversityNoticesTab extends StatefulWidget {
  @override
  _UniversityNoticesTabState createState() => _UniversityNoticesTabState();
}

class _UniversityNoticesTabState extends State<UniversityNoticesTab> {
  bool isLoading;
