                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Lottie.asset(
                              'assets/lottie/aboutScreenAnim.json'),
                    ...
                    onTap: () => Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: WebViewContainer(
                            "https://www.kccitm.edu.in/", "KCCITM"),
                      ),
                    ),
                  ),
                  SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          AboutIcon(
                            ...
                            url: "https://twitter.com/KCCinstitutes",
                            linkTitle: "Twitter",
                          ),
                          AboutIcon(
                            iconData: FontAwesomeIcons.facebookF,
                            url: "https://www.facebook.com/KCCinstitutes/",
                            linkTitle: "Facebook",
                          ),
                          AboutIcon(
                            iconData: FontAwesomeIcons.instagram,
                            url: "https://www.instagram.com/kccinstitutes/",
                            linkTitle: "Instagram",
                          ),
                          AboutIcon(
                            iconData: FontAwesomeIcons.linkedinIn,
                            url:
                                "https://www.linkedin.com/school/kcc-institute-of-technology-and-management",
                            linkTitle: "LinkedIn",
                          ),
                        ],
                      ),
...
class AboutIcon extends StatelessWidget {
  ...
  AboutIcon({Key key, this.iconData, this.url, this.linkTitle})
      : super(key: key);
